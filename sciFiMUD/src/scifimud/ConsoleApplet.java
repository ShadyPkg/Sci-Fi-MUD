...
public class ConsoleApplet extends java.applet.Applet
   ...
   protected String title = "Digital Wastelands";  // (Used for compatibility with previous versions of Console Applet)
   ...
   public static  ConsolePanel console;  // console for use in program()
   ...
   public void init() {
      ...
      runButton = new Button("Play Digital Wastelands");
      temp = new Panel();
      temp.setBackground(Color.white);
      temp.add(runButton);
   ...
   synchronized public void actionPerformed(ActionEvent evt) { 
      ...
      if (programThread != null) {
         stopProgram();
          try {
              ConnectPlayer.savePlayer();
          } catch (FileNotFoundException ex) {
              Logger.getLogger(ConsoleApplet.class.getName()).log(Level.SEVERE, null, ex);
