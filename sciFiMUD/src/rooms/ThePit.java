...
public class ThePit {
    ...
    public ThePit(int id){
        roomID = id;
    }
    
    public ThePit(String desc){
        roomDescription = desc;
    }
    
    //initalize basic directions
    public ThePit(boolean n, boolean e, boolean s,  boolean w){
        north = n;
        east = e;
        south = s;
        west = w;
    ...
    public ThePit(boolean n, boolean e, boolean s,  boolean w, boolean u, boolean d, boolean nD, boolean eD,  boolean sD, boolean wD,  boolean sec){
        north = n;
        east = e;
        south = s;
        west = w;
